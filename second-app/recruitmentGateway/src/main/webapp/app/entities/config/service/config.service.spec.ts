...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../config.test-samples';

import { ConfigService, RestConfig } from './config.service';

const requireRestSample: RestConfig = {
