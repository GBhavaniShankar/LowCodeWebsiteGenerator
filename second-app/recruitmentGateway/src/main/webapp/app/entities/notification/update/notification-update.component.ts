...
export class NotificationUpdateComponent implements OnInit {
  ...
  notificationSourceValues = Object.keys(NotificationSource);
    ...
    this.applicantService
      ...
      .pipe(
        map((applicants: IApplicant[]) =>
          this.applicantService.addApplicantToCollectionIfMissing<IApplicant>(applicants, this.notification?.recipient),
        ),
      )
