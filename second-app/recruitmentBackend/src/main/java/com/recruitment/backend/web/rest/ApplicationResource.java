...
/**
 * REST controller for managing {@link com.recruitment.backend.domain.Application}.
 */
@RestController
...
public class ApplicationResource {
    ...
    private static final String ENTITY_NAME = "recruitmentBackendApplication";
    ...
    public ResponseEntity<ApplicationDTO> createApplication(@Valid @RequestBody ApplicationDTO applicationDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/applications/" + applicationDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, applicationDTO.getId().toString()))
            .body(applicationDTO);
    }
