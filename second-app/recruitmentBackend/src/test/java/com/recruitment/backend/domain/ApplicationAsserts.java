...
public class ApplicationAsserts {
    ...
    public static void assertApplicationUpdatableFieldsEquals(Application expected, Application actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getUniqueNumber()).as("check uniqueNumber").isEqualTo(expected.getUniqueNumber()))
            .satisfies(a -> assertThat(a.getSubmissionDate()).as("check submissionDate").isEqualTo(expected.getSubmissionDate()))
            .satisfies(a -> assertThat(a.getStatus()).as("check status").isEqualTo(expected.getStatus()))
            .satisfies(a -> assertThat(a.getPaymentSuccessful()).as("check paymentSuccessful").isEqualTo(expected.getPaymentSuccessful()));
    }
    ...
    public static void assertApplicationUpdatableRelationshipsEquals(Application expected, Application actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getApplicant()).as("check applicant").isEqualTo(expected.getApplicant()))
            .satisfies(a -> assertThat(a.getFeeCategory()).as("check feeCategory").isEqualTo(expected.getFeeCategory()));
    }
}
